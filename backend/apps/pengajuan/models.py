...
class PengajuanKP(models.Model):
    ...
    periode = models.ForeignKey(PeriodeSemester, on_delete=models.SET_NULL, null=True, blank=True)
    judul_diajukan = models.CharField(max_length=255)
    deskripsi_sistem = models.TextField()
    status_pengajuan = models.CharField(max_length=25, default='submitted')
