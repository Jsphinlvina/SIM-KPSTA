...
class PengajuanViewSet(viewsets.ModelViewSet):
    ...
    def ajukan_topik_dosen(self, request):
        try:
            ...
            return ok(data=self.get_serializer(pengajuan).data, message="Draft pengajuan topik dosen dibuat.")
        except Exception as e: return fail(message=str(e))
    ...
    def ajukan_mandiri(self, request):
        try:
            ...
            return ok(data=self.get_serializer(pengajuan).data, message="Draft pengajuan mandiri dibuat.")
        except Exception as e: return fail(message=str(e))
