...
import { BimbinganScheduleManager, BimbinganRequest } from "./approval-state";

export default function ApprovalPage() {
  const [requests, setRequests] = useState<BimbinganRequest[]>([]);

  // Load requests from Singleton Manager on component mount
  useEffect(() => {
    const manager = BimbinganScheduleManager.getInstance();
