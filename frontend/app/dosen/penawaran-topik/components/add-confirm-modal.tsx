    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
      <div className="w-full max-w-lg bg-white rounded-3xl p-8 shadow-2xl relative border border-[#e6eef5]">
        <div className="flex items-center gap-3 text-[#355872] mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#355872]">Konfirmasi Tambah Topik</h2>
        </div>

        <p className="text-gray-500 font-medium text-sm leading-relaxed mb-6">
          Apakah Anda yakin ingin merilis dan menawarkan topik Kerja Praktik baru ini kepada mahasiswa?
        </p>
        ...
        <div className="bg-[#EAF4FB] p-5 rounded-2xl border border-[#9CD5FF]/20 mb-6 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2.5 border-t border-[#355872]/10">
            <div>
              <span className="text-xs uppercase font-bold text-gray-400 tracking-wider">Kuota</span>
          ...
          <div className="pt-2.5 border-t border-[#355872]/10">
            <span className="text-xs uppercase font-bold text-gray-400 tracking-wider">Deskripsi Rencana</span>
